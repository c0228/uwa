...
import { ContainerFluid, Row, Col, Icon, Alert } from "e-ui-react";
...
const FontAwesomeIcons = ()=>{
    ...
    "fa-edit", "fa-ellipsis-h", "fa-ellipsis-v", "fa-envelope", "fa-envelope-o", "fa-envelope-open", "fa-envelope-open-o", "fa-envelope-square",
    ...
    "fa-hand-lizard-o", "fa-hand-paper-o", "fa-hand-peace-o", "fa-hand-pointer-o", "fa-hand-rock-o", "fa-hand-scissors-o", "fa-hand-spock-o", "fa-hand-stop-o", "fa-handshake-o",
    ...
    "fa-thumb-tack", "fa-thumbs-down", "fa-thumbs-o-down", "fa-thumbs-o-up", "fa-thumbs-up", "fa-ticket", "fa-times", "fa-times-circle", "fa-times-circle-o", "fa-times-rectangle",
    ...
    "fa-volume-control-phone", "fa-volume-down", "fa-volume-off", "fa-volume-up", "fa-warning", "fa-wheelchair", "fa-wheelchair-alt", "fa-wifi", "fa-window-close", "fa-window-close-o",
    "fa-window-maximize", "fa-window-minimize", "fa-window-restore", "fa-wrench" ];

 return (<>
  <ContainerFluid>
    <Row>
        <Alert type="warning" show={true} body={<div>
            <b>Note:</b> To rotate FontAwesome Icons, use <code><b><i>fa-spin</i></b></code>.
            For example,
            <b>{'<Icon type="FontAwesome" name="fa-cog fa-spin" size="36" style={{ color:"dodgerBlue" }} />'}</b>
         </div>}/>
    </Row>
    <Row>
        {icons?.map((icon, index)=>{
            return (<Col key={index} xxl={1} xl={1}>
