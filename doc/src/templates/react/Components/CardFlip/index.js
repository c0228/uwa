...
console.log(SampleCodeJS.toString());
 const Note1 = () =>{
  return (<>
  <div className="mtop10p mbot10p"><b>Simple CardFlip:</b></div>
...
export const CardFlipPage = () =>{
 ...
 return (<>
 <DocumentHeader title="CardFlip" componentAttributesTable={ComponentAttributesTable} />
 <ContainerFluid>
  <Row>
    <Col><CardFlipNotes /></Col>
  </Row>
 </ContainerFluid>
 </>);
};