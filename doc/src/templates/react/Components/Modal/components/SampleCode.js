...
export const SampleNote1 = () =>{
 ...
 const SimpleModal = ()=>{
  ...
  const HelloWorld = ()=>{
    return (<div style={{ padding:'15px' }}>Hello World</div>);
  };
  ...
  return (<>
    ...
    <Modal title="Modal Header" show={showModel} onClose={setShowModal} 
      colorConfig={{
        header: { backgroundColor:'red', color:'white', borderColor:'white' },
        body: { backgroundColor:'blue', color:'yellow', borderColor:'orange' }
      }}>
     <HelloWorld />
    </Modal>
  </>);
