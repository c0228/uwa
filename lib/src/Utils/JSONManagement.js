...
export const cleanJSONString = (jsonString) => { // Replace any newline characters and trim the string to remove excess spaces
  /**
   *  "key1": "value1
   *  ","key2":"value2"
...
export const CompareJSONArrays = (array1, array2) => { // Difference - true, Nodifference - false
 // Ensure both arrays are valid JSON arrays
 if(!Array.isArray(array1) || !Array.isArray(array2)) { return false; }
 // Check array lengths
 if(array1.length !== array2.length) { return true;  } // Different lengths indicate changes
