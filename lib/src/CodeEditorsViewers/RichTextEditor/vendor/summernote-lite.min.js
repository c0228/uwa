  ...
  3: function (t, e, n) {
   ...
   function bt(t, e) {
    ...
    for (n = 0; n < a.length; n++)
     if (!pt.isText(a[n])) {
      if (
       (r.moveToElementText(a[n]), r.compareEndPoints('StartToStart', t) >= 0)
      )
       break;
      o = a[n];
     }
      ...
      (n = [
       {
        ...
        value: function () {
         ...
         return (
          e.setEndPoint('EndToEnd', kt({ node: this.ec, offset: this.eo })), e
         );
        },
       },
       {
       ...
       },
       {
        ...
        value: function () {
         ...
         if (e) {
          ...
          if (
           (i = i.concat(pt.listNext(e.nextSibling, pt.isParaInline))).length
          ) {
         ...
         switch (c.action) {
          ...
          case At.resultAction.SumSpanCount:
           if (
            ...
            var d = i()('<div></div>')
             .append(
              i()('<td' + u + '>' + pt.blank + '</td>').removeAttr('rowspan')
             )
             .html();
            a.append(d);
            break;
    ...
    return (
     ...
     (n = [
      ...
      },
      {
       ...
       value: function () {
        return (
         pt.isEmpty(this.$editable[0]) || pt.emptyPara === this.$editable.html()
        );
       },
      },
      {
         ...
         : this.$statusbar.on('mousedown', function (e) {
            ...
            var n = t.$editable.offset().top - t.$document.scrollTop(),
             o = function (e) {
              ...
              (o =
               t.options.minheight > 0 ? Math.max(o, t.options.minheight) : o),
               (o =
                t.options.maxHeight > 0 ? Math.min(o, t.options.maxHeight) : o),
               t.$editable.height(o);
             };
           ...
           this.ui.dropdown({
            ...
            click: function (e) {
             ...
             if ('openPalette' === a) {
              var l = n.find('#' + s),
               c = i()(
                n.find('#' + l.data('event')).find('.note-color-row')[0]
               ),
           ...
           t.context.memo('button.style.' + o, function () {
            return t
             .button({
              ...
              contents:
               '<div data-value="' + o + '">' + o.toUpperCase() + '</div>',
         ...
         this.context.memo('button.underline', function () {
          return t
           .button({
            ...
            click:
             t.context.createInvokeHandlerAndUpdateState('editor.underline'),
           })
           .render();
         }),
         ...
         this.context.memo('button.strikethrough', function () {
          return t
           .button({
            ...
            tooltip:
             t.lang.font.strikethrough + t.representShortcut('strikethrough'),
         ...
         this.context.memo('button.superscript', function () {
          return t
           .button({
            ...
            click:
             t.context.createInvokeHandlerAndUpdateState('editor.superscript'),
           })
           .render();
         }),
         this.context.memo('button.subscript', function () {
          return t
           .button({
            ...
            click:
             t.context.createInvokeHandlerAndUpdateState('editor.subscript'),
           })
           .render();
         }),
           ...
           t.ui
            .buttonGroup([
             ...
             t.ui.dropdownCheck({
              ...
              click:
               t.context.createInvokeHandlerAndUpdateState('editor.fontName'),
             }),
            ])
            .render()
          );
          ...
          return t.ui
           .buttonGroup([
            ...
            t.ui.dropdownCheck({
             ...
             click:
              t.context.createInvokeHandlerAndUpdateState('editor.fontSize'),
            }),
           ])
           .render();
         }),
         ...
         this.context.memo('button.ol', function () {
          return t
           .button({
            ...
            tooltip:
             t.lang.lists.ordered + t.representShortcut('insertOrderedList'),
         ...
         this.context.memo('button.hr', function () {
          return t
           .button({
            ...
            tooltip:
             t.lang.hr.insert + t.representShortcut('insertHorizontalRule'),
       ...
       value: function (t) {
        ...
        if (n && 11 === n[1].length) {
         ...
         e = i()('<iframe>')
          ...
          .attr(
           'src',
           '//www.youtube.com/embed/' + m + (v > 0 ? '?start=' + v : '')
          )
          .attr('width', '640')
          .attr('height', '360');
     ...
     (n = [
      ...
      },
      {
       ...
       value: function () {
        ...
        if (t.length) {
         ...
         if (
          (this.lastWordRange.insertNode(e), 'next' === this.options.hintSelect)
         ) {
      ...
      },
      {
       ...
       value: function (t, e) {
        var n = this,
         o = i()(
          '<div class="note-hint-group note-hint-group-' + t + '"></div>'
         );
        return (
       ...
       x({
        ...
        callback: function (n) {
         n.find('.note-holder').each(function () {
          var e = i()(this);
          e.append(
           P({ colors: t.colors, eventName: e.data('event') }).render()
          );
         }),
          'fore' === e
