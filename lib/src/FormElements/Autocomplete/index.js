...
import { FilterArray, FormInputValidate, KeyPressValidate, getForm, FORM_SUBMITTED, FORM_RESET } from "e-ui-react";
import './index.css';
...
export const Autocomplete = ({ name, label, placeholder, value, autoCompleteData, validation }) => {
 ...
 // const [validationStatus, setValidationStatus] = useState({});
  ...
  const validateOnSubmit = ( (FormMode === FORM_SUBMITTED) || autoCompleteValue?.length > 0);
