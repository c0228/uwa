...
export const DateTimePicker = ({
  ...
  const [dateTimePickerValue, setDateTimePickerValue] =
    useState(initialValue);

  const [tmpValue, setTmpValue] = useState(
    getInitialDateTimeValue(initialValue)
  );

  const InfoIcon = () =><Icon type="FontAwesome" name="fa-info-circle" size={12} style={{ marginRight:'2px' }} />
  /**
   * Validation
