...
export const Select = ({ style, name, label, placeholder, value, validation, options, className, width, fontSize, onChange }) => {
  ...
  if(mediaQuery?.matches) {  selectStyles={...selectStyles, width: getResponsiveStyle(sWidth), fontSize: getResponsiveStyle(sfontSize) }; }
  else { selectStyles={...selectStyles, width: getResponsiveStyle(sWidth), fontSize: getResponsiveStyle(sfontSize) }; }
