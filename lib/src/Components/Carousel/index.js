...
export const Carousel = ({ id, data }) =>{
 ...
 const buildCarousel = () =>{
    ...
    {data?.map((d,i)=>{
        ...
        /* Carousel Data  */
        buildCarouselData.push(<div className={i===slideIndex?"carousel-item active":"carousel-item  carousel-item-next"}>
            <img src={d?.img?.src} alt={d?.img?.alt} className="d-block w-100" />
