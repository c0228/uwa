...
export const Modal = ({ width, type, title, show, onClose, fullScreen, children })=>{
 ...
 return (<>
    <div className={(type!==undefined)?"modal modal-"+type:"modal"} style={{ display: show?'block':'none' }}>
      <div className={isFullScreen?"modal-dialog modal-fullscreen":"modal-dialog"} style={{ maxWidth: width}}>
