   ...
   <div className="modal-content">
     <div className="modal-body" style={{ padding:'0px' }}>
      <div className="alert alert-success alert-dismissible" style={{ marginBottom:'0px' }}>
        ...
        <Row>
            <Col md={1} sm={2}>
              <div align="center" style={{ display:'flex', justifyContent:'center', alignItems:'center', minHeight:'30px' }}>
                <Icon type="FontAwesome" name={icon} size={28} /></div>
            </Col>
            <Col md={11} sm={10}>
             <div style={{ display:'flex', justifyContent:'flex-start', alignItems:'center', minHeight:'30px' }}>{title}</div>
            </Col>
        </Row>
      </div>
     </div>
